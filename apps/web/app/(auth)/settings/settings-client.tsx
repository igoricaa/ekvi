...
import { CheckCircle, EditIcon, Loader2, Mail } from "lucide-react";
...
type SettingsClientProps = {
  preloadedUser: Preloaded<typeof api.profiles.getCurrentUser>;
};
...
export function SettingsClient({ preloadedUser }: SettingsClientProps) {
  ...
  // Use preloaded data - instant render, still reactive
  ...
  const handleResendVerification = async () => {
    if (verificationCooldown > 0 || isResendingVerification) {
      return;
    }
      ...
      <Card className="mt-6">
        ...
        <CardContent className="space-y-4">
          <div className="flex items-center gap-2">
            {currentUser.authUser.emailVerified ? (
              <>
